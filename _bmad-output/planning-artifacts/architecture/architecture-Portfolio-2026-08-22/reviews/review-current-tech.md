...
| Exact package set | PASS | Every architecture-listed exact version is published and not deprecated. Registry peer ranges align across React/DOM `19.2.6`, R3F `9.6.1`, Drei `10.7.7`, Three `0.184.0`, Framer Motion `11.18.2`, Vite `8.0.16`, Vitest/coverage `4.1.8`, and the remaining test/font/PDF tools. Newer registry releases do not invalidate this reproducible compatible pin set. |
