...
- Release fixtures pass 33 tests covering canonical/file digests, archive traversal/link rejection, manifest ownership, GeneratedEvidence phases, history rules/rewrite, review binding, smoke order, and ReleaseEvidence schema.
